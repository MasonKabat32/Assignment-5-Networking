...
namespace Aftr
{
	class Messenger : public NetMsg
	{
	public:
		NetMsgMacroDeclaration(Messenger);

		Messenger(); // constructor, not really sure if anything signifigant will have to be done here
		virtual ~Messenger(); //DO NOT FORGET ABOUT THIS IF YOU ALLOCATE ANYTHING
